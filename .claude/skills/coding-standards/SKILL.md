...
description: TypeScript、JavaScript、React、Node.js開発のためのユニバーサルなコーディング規約、ベストプラクティス、パターンです。
---

# Coding Standards & Best Practices

すべてのプロジェクトに適用可能なユニバーサルなコーディング規約です。
...
```typescript
// ✅ 良い: WHYを説明、WHATではない
// 障害時にAPIを圧倒しないように指数バックオフを使用
const delay = Math.min(1000 * Math.pow(2, retryCount), 30000)

// 大きな配列でのパフォーマンスのためここでは意図的にミューテーションを使用
items.push(newItem)
...
**覚えておいてください**: コード品質は交渉不可能です。明確で保守可能なコードは、迅速な開発と自信を持ったリファクタリングを可能にします。
